  ...
  node(label) {
    stage("Prepare") {
      container("builder") {
        ...
        // RUN_DISPLAY_URL = "https://$JENKINS/blue/organizations/jenkins/$JOB_NAME/detail/$JOB_NAME/$BUILD_NUMBER/RUN_DISPLAY_URL"
      }
    }
    stage("Checkout") {
      container("builder") {
